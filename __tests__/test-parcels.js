...
describe('Branches API', () => {
  describe('Given the root URL', () => {
    ...
    it ('should be able to POST an entry', (done) => {
      request.post(baseurl)
        .send({id:7000000, "name": "Test Value","location": "175.7120","contact_info": "291-144-3788","address": "6815 Kasarani"})
        .set('Accept', 'application/json')
        .end((err, res) => {
          expect(res.status).toBe(201)
  ...
  describe('Given a branch ID', () => {
    beforeAll((done) => {
      ...
      request.post(baseurl)
        .send({"id":5000000, "name": "Keanu Track","location": 65.7387,"contact_info": "919-320-7344","address": "2695 Heaney Place"})
        .set('Accept', 'application/json')
        .end((err, res) => {
          expect(res.status).toBe(201)
          done()
      ...
      request.post(baseurl)
        .send({"id":9000000, "name": "Test Value","location": "175.7120","contact_info": "291-144-3788","address": "6815 Kasarani"})
        .set('Accept', 'application/json')
        .end((err, res) => {
          expect(res.status).toBe(201)
          done()
